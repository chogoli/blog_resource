...
install_dnsmasq(){
    ...
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/chogoli/blog_resource/main/dnsmasq_sniproxy_install/proxy-domains.txt
...
install_sniproxy(){
    ...
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/chogoli/blog_resource/main/dnsmasq_sniproxy_install/proxy-domains.txt
